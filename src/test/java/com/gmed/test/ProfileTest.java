...
//		DemographicsPage.existingPatientfirstname                   = DemographicsPage.demographicsData.get(DemographicsTest.PATIENT_FIRSTNAME);
//		DemographicsPage.existingPatientlastname                    = DemographicsPage.demographicsData.get(DemographicsTest.PATIENT_LASTNAME);
//		existingProfilePatientDateOfBirth                           = profileData.get(PROFILE_PATIENT_DATEOFBIRTH);
//		existingPatientAge                                          = DemographicsPage.demographicsData.get(DemographicsTest.PATIENT_AGE);
//		DemographicsPage.existingPatientrecordnumber                = DemographicsPage.demographicsData.get(DemographicsTest.PATIENT_RECORDNUMBER);
//		existingProfilepatientSSN                                   = DemographicsPage.demographicsData.get(DemographicsTest.PATIENT_SSNNUMBER);
...
//		DemographicsPage.existingPatientFromAge                     = DemographicsPage.demographicsData.get(DemographicsTest.PATIENT_FROM_AGE);
//		DemographicsPage.existingPatientToAge                       = DemographicsPage.demographicsData.get(DemographicsTest.PATIENT_TO_AGE);
