...
import static com.gmed.helper.DriverFactory.*;
...
*//**
 * <p>This class is used for initialization of different URL of Gmed Environment like Develop,Release and Enhance
 </p>
 * @author jyoti.kalra
 *
 *//*

public  class BaseTestClass1 extends BaseAbstractPage{
	*//** Logger to log the BaseTestClass log messages *//*
	private static Logger logger = LogManager.getLogger(BaseTestClass1.class);
